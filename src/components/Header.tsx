...
export default () => {
  ...
  return (
    <>
      <nav
        className={`relative z-20 bg-[rgb(22,22,24)] w-full  md:static md:text-sm md:border-none ${
              ...
              <div className="flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0">
                ...
                <li>
                  <a
                    ...
                    className="block py-3 px-4 font-medium text-center text-white hover:text-indigo-600 active:shadow-none rounded-lg shadow md:inline"
                  >
                    Sign in
                  </a>
                </li>
